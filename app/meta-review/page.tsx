...
export const metadata: Metadata = {
  title: "Meta App Review Support - Ongevia",
  description:
    "Meta App Review notes for Ongevia's official Instagram private reply workflow.",
};
...
export default function MetaReviewPage() {
  return (
    <LegalShell
      ...
      description="Ongevia is designed for Instagram professional accounts that want to send private replies after keyword comments on their own posts or reels."
    ...
    >
      <section>
        ...
        <p className="mt-3">
          ...
          reel, and receives a webhook when someone comments. Ongevia queues
