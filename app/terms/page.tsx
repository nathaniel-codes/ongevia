...
export const metadata: Metadata = {
  ...
  description:
    "Terms for using Ongevia's Instagram comment-to-DM campaign software.",
};
...
export default function TermsPage() {
  return (
    <LegalShell
      ...
      description="These terms define acceptable use for Ongevia's hosted Instagram comment-to-DM campaign service."
      updatedAt="May 24, 2026"
    >
      <section>
        <h2 className="text-xl font-bold text-white">Authorized Use</h2>
        <p className="mt-3">
          You may use Ongevia only with Instagram professional accounts you
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          Ongevia may rate-limit, pause, or disable campaigns that create
      ...
      <section>
        ...
        <p className="mt-3">
          Ongevia depends on third-party platforms including Meta, email,
