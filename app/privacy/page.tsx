...
export const metadata: Metadata = {
  ...
  description:
    "How Ongevia handles Instagram account data, webhook payloads, billing data, and customer campaign information.",
};
...
export default function PrivacyPage() {
  return (
    <LegalShell
      ...
      description="Ongevia helps businesses send Meta-compliant private replies when people comment on connected Instagram posts or reels."
    ...
    >
      ...
      <section>
        ...
        <p className="mt-3">
          Ongevia does not ask for Instagram passwords, scrape Instagram, or
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          the support email configured for the hosted Ongevia service.
        </p>
      </section>
    </LegalShell>
  );
